...
<div style="background:#1a1a1a;border-radius:10px;padding:15px;color:white;font-family:monospace">
  <div style="color:#FF6B6B">PortaPack ➔ <span style="color:#4ECDC4">KaliNova</span></div>
  <div style="margin-left:20px">
    <div>├─ <span style="color:#FFE66D">RF Scan</span></div>
    <div>├─ Exploit DB</div>
    <div>└─ <span style="color:#A569BD">GPS Spoofing</span></div>
  </div>
</div>
